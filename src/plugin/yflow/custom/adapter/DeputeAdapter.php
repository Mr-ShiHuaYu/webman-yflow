 ...
 * @since 2023/5/29
 */
class DeputeAdapter extends AbstractWarmFlowAdapter implements WarmFlowAdapter
{
    ...
    {
        return $warmFlowType == CooperateType::DEPUTE->value;
    }
    ...
    public function adapter(array $obj): bool
    {
        ...
        return $this->taskService->depute($taskId, $flowParams);
    }
}
