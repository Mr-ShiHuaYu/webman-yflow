 ...
 * @since 2023/5/29
 */
class TransferAdapter extends AbstractWarmFlowAdapter implements WarmFlowAdapter
{
    /**
     * 判断是否适配指定的流程类型
     *
    ...
    {
         return $warmFlowType == CooperateType::TRANSFER->value;
    }
    ...
    public function adapter(array $obj): bool
    {
        ...
        return $this->taskService->transfer($taskId, $flowParams);
    }
}
